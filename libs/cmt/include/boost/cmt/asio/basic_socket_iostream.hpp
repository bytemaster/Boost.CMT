...
#ifndef BOOST_CMT_ASIO_BASIC_SOCKET_IOSTREAM_HPP
#define BOOST_CMT_ASIO_BASIC_SOCKET_IOSTREAM_HPP
...
#include <boost/cmt/asio/basic_socket_streambuf.hpp>
...
#define BOOST_ASIO_PRIVATE_CTR_DEF(z, n, data) \
  ...
  explicit basic_socket_iostream(BOOST_PP_ENUM_BINARY_PARAMS(n, T, x)) \
    : std::basic_iostream<char>(&this->boost::base_from_member< \
        boost::cmt::asio::basic_socket_streambuf<Protocol, StreamSocketService> >::member) \
  { \
    tie(this); \
...
class basic_socket_iostream
  : public boost::base_from_member<
      boost::cmt::asio::basic_socket_streambuf<Protocol, StreamSocketService> >,
...
#endif // BOOST_CMT_ASIO_BASIC_SOCKET_IOSTREAM_HPP
