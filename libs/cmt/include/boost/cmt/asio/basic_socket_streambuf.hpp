...
#ifndef BOOST_CMT_ASIO_BASIC_SOCKET_STREAMBUF_HPP
#define BOOST_CMT_ASIO_BASIC_SOCKET_STREAMBUF_HPP
...
protected:
  ...
  int_type overflow(int_type c)
  {
    if (unbuffered_)
    {
     ...
     //   boost::cmt::asio::write( *this, 
     //           boost::asio::buffer(&ch, sizeof(char_type)), ec);
